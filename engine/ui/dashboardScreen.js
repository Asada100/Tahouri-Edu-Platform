...
//
// Removed legacy action buttons and daily-report screen.
// =====================================
...
const DashboardScreen = {
    ...
    show: function (data) {
        ...
        const gradeTitles = { grade1: "پایه اول", grade2: "پایه دوم", grade3: "پایه سوم", grade4: "پایه چهارم", grade5: "پایه پنجم", grade6: "پایه ششم", grade7: "پایه هفتم", grade8: "پایه هشتم", grade9: "پایه نهم" };
        ...
        app.innerHTML = `<div class="screen dashboard-screen"><div class="dashboard-welcome"><h1>👋 سلام ${studentName}</h1>${gradeTitle ? `<p>🎓 ${gradeTitle}</p>` : ""}</div>${continueCard}<hr><div class="dashboard-card learning-calendar-card"><div class="learning-calendar-heading"><div><h2>📅 تقویم مسیر یادگیری</h2><p>تقویم فعالیت‌های یادگیری</p></div><div class="streak-badge">🔥 <strong>${streak}</strong> <span>روز</span></div></div><div id="learningCalendarContainer">${this.calendar()}</div></div><div class="dashboard-card"><h2>💬 یک جمله برای تو</h2><div class="dashboard-message"><span>🚀</span><p>قدم‌به‌قدم داری جلو می‌ری. با همین تمرکز ادامه بده!</p></div></div><div class="dashboard-card"><h2>🏅 وضعیت من</h2><p>${completedCount} فعالیت از ${totalActivities} فعالیت کامل شده است. <strong>${progressPercentage}%</strong></p></div></div>`;

        this.bind(continueLearning);
        this.styles();
        console.log("Dashboard Screen v11.1 Ready");
    },
